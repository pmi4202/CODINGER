...
urlpatterns = [
    ...
    path('app/order/add/<int:menu_id>/', DeliveryUserApp.views.user_order_add, name='user_order_add'),
    path('app/order/add/<int:menu_id>/minus', DeliveryUserApp.views.user_menu_minus, name='user_menu_minus'),
    path('app/order/add/<int:menu_id>/plus', DeliveryUserApp.views.user_menu_plus, name='user_menu_plus'),
    # path('app/order/add/1/', DeliveryUserApp.views.user_order_add, name='user_order_add'),
